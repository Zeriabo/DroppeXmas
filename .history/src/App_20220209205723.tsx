  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        ...
        <div> <Cart childId={0} date={new Date(card2.date).toLocaleDateString()} cartItems={card2.products} child={0}  /></div> 
        <div> <Cart childId={0} date={new Date(card3.date).toLocaleDateString()} cartItems={card3.products} child={0}  /></div> 
        <div> <Cart childId={0} date={new Date(card4.date).toLocaleDateString()} cartItems={card4.products} child={0}  /></div> 
        <div> <Cart childId={0} date={new Date(card5.date).toLocaleDateString()} cartItems={card5.products} child={0}  /></div> 
       <div>
