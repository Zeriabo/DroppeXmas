...
//cards.reducer.card1.products[0].id=9
console.log(cards.reducer.card1.products[0])
  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        ...
        <div> 
          <Cart childId={0} date={new Date(cart1.date).toLocaleDateString()} cartItems={firstCart.products} child={0}  />
