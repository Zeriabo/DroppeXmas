...
var products= cards.reducer.products
 ...
 for(const p in cards.reducer.card1.products){
   dispatch(removeProductFromCardOne)
 }
  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        ...
        <div> <Cart childId={0} date={new Date(cart1.date).toLocaleDateString()} cartItems={cards.carts[0]} child={0}  /></div> 
       <div>
