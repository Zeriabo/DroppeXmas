...
export interface CardTwoState {
  ...
  export const { addProductToCardTwo,replaceProducts,card1Success,calcTotal,calcTotalDecrement,ApproveTwo,Decline, initiateState,removeProductFromCardTwo,IncrementAmountTwo,calcTotalCard2,decreaseAmountTwo } = cardTwoSlice.actions
