...
export interface CardTwoState {
  ...
  export const { addProductToCardTwo,replaceProducts,card1Success,calcTotal,calcTotalCard2Decrement,ApproveTwo,Decline, initiateState,removeProductFromCardTwo,IncrementAmountTwo,calcTotalCard2,decreaseAmountTwo } = cardTwoSlice.actions
