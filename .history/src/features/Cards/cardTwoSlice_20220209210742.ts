...
export interface CardTwoState {
  ...
  let cardTwoSlice = createSlice({
    ...
    action.payload.approved=true;
      ...
      calcCard2Total(state,action:PayloadAction<{}>) {       
  ...
  export const { addProductToCardTwo,replaceProducts,card1Success,calcTotal,calcTotalDecrement,ApproveTwo,Decline, initiateState,removeProductFromCardTwo,IncrementAmountTwo,calcCard2Total,decreaseAmountTwo } = cardTwoSlice.actions
