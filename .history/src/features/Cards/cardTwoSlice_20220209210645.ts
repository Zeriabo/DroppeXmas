...
export interface CardTwoState {
  ...
  export const { addProductToCardTwo,replaceProducts,card1Success,calcTotal,calcTotalDecrement,Approve,Decline, initiateState,removeProductFromCardTwo,IncrementAmountTwo,calcCard1Total,decreaseAmountTwo } = cardTwoSlice.actions
